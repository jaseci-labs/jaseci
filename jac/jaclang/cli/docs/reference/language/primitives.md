...
- **Server is the default element placement.** Within a module anchored to the server (endpoints, walkers, PyPI imports, JSX, tests, ...), unmarked code compiles to the Python backend, exactly as before.
