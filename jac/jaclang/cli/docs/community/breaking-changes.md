...
| `[project] kind = "mobile"` as the Capacitor web-view shell (`client_target = "mobile"`, `client_kind = "web"`) | `mobile` is the React Native mobUI app (`client_target = "react-native"`, `client_kind = "mobui"`); set `client = "mobile"` on the app table to keep the Capacitor shell |
