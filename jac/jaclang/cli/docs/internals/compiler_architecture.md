...
are generated accessors over those edges
(`unitree.impl/roles.impl.jac`, regenerated by `scripts/gen_roles.py` from the
declarations in `unitree.jac` and the `ROLE_SLOTS` table). `kid` is every
