...
# Must equal jaclang.jac0core.jir.FORMAT_VERSION (kept literal for bootstrap).
# Bumped 18 -> 19 alongside the SEC_MTIR Info.mod_path ownership stamp; see
# the rationale on FORMAT_VERSION in jir.jac.
