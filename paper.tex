...
matched \code{pybind11} module and a hand-written \code{METH\_O} C extension,
plus each side's no-FFI arithmetic floor.
...
and deployment-path cross-runtime floors of $241\times$ and $374\times$ for the
