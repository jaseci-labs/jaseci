"""P2 wave-6 c2jac corpus lift + Tier-B density ratchet."""
...
_BASELINE = _HERE / "p2_corpus_wave6" / "baseline" / "project.c2jac.report.json"
_LIFT = _HERE / "lift_p2_corpus_wave6.py"
...
class P2CorpusWave6GateTests(unittest.TestCase):
    @classmethod
