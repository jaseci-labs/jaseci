"""P2 c2jac corpus lift + Tier-B density ratchet (jac-py/PLAN.md §7 P2)."""
...
_BASELINE = _HERE / "p2_corpus" / "baseline" / "project.c2jac.report.json"
_LIFT = _HERE / "lift_p2_corpus.py"
...
class P2CorpusGateTests(unittest.TestCase):
    @classmethod
    ...
    def test_baseline_manifest_is_present(self) -> None:
        ...
        manifest = json.loads(_MANIFEST.read_text(encoding="utf-8"))
        self.assertGreaterEqual(len(baseline.get("files", [])), 10)
