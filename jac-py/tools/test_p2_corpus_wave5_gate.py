"""P2 wave-5 c2jac corpus lift + Tier-B density ratchet."""
...
_BASELINE = _HERE / "p2_corpus_wave5" / "baseline" / "project.c2jac.report.json"
_LIFT = _HERE / "lift_p2_corpus_wave5.py"
...
class P2CorpusWave5GateTests(unittest.TestCase):
    @classmethod
