"""P2 wave-2 c2jac corpus lift + Tier-B density ratchet."""
...
_BASELINE = _HERE / "p2_corpus_wave2" / "baseline" / "project.c2jac.report.json"
_LIFT = _HERE / "lift_p2_corpus_wave2.py"
...
class P2CorpusWave2GateTests(unittest.TestCase):
    @classmethod
