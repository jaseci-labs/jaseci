"""P2 wave-3 c2jac corpus lift + Tier-B density ratchet."""
...
_BASELINE = _HERE / "p2_corpus_wave3" / "baseline" / "project.c2jac.report.json"
_LIFT = _HERE / "lift_p2_corpus_wave3.py"
...
class P2CorpusWave3GateTests(unittest.TestCase):
    @classmethod
