"""P2 wave-9 c2jac corpus lift + Tier-B density ratchet."""
...
_BASELINE = _HERE / "p2_corpus_wave9" / "baseline" / "project.c2jac.report.json"
_LIFT = _HERE / "lift_p2_corpus_wave9.py"
...
class P2CorpusWave9GateTests(unittest.TestCase):
    @classmethod
