"""P2 wave-7 c2jac corpus lift + Tier-B density ratchet."""
...
_BASELINE = _HERE / "p2_corpus_wave7" / "baseline" / "project.c2jac.report.json"
_LIFT = _HERE / "lift_p2_corpus_wave7.py"
...
class P2CorpusWave7GateTests(unittest.TestCase):
    @classmethod
