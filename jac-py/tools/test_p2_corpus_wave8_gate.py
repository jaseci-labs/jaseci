"""P2 wave-8 c2jac corpus lift + Tier-B density ratchet."""
...
_BASELINE = _HERE / "p2_corpus_wave8" / "baseline" / "project.c2jac.report.json"
_LIFT = _HERE / "lift_p2_corpus_wave8.py"
...
class P2CorpusWave8GateTests(unittest.TestCase):
    @classmethod
