"""P2 wave-6 conformance manifest gate."""
...
_MANIFEST = _REPO / "jac-py" / "tests" / "conformance_manifest_wave6.json"
_CORPUS = _HERE / "p2_corpus_wave6" / "manifest.json"
_STAGED = _HERE / "p2_staged_manifest_wave6.json"

_ALLOWED_GATE_TYPES = frozenset({"oracle", "libtest", "deferred"})


class P2ConformanceWave6GateTests(unittest.TestCase):
