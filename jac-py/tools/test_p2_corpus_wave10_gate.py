"""P2 wave-10 c2jac corpus lift + Tier-B density ratchet."""
...
_BASELINE = _HERE / "p2_corpus_wave10" / "baseline" / "project.c2jac.report.json"
_LIFT = _HERE / "lift_p2_corpus_wave10.py"
...
class P2CorpusWave10GateTests(unittest.TestCase):
    @classmethod
