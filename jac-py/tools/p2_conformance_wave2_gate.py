"""P2 wave-2 conformance manifest gate."""
...
_MANIFEST = _REPO / "jac-py" / "tests" / "conformance_manifest_wave2.json"
_CORPUS = _HERE / "p2_corpus_wave2" / "manifest.json"
_EXPECTED_COUNT = 4
_ALLOWED_GATE_TYPES = frozenset({"oracle", "libtest", "deferred"})


class P2ConformanceWave2GateTests(unittest.TestCase):
