"""P2 wave-10 conformance manifest gate."""
...
_MANIFEST = _REPO / "jac-py" / "tests" / "conformance_manifest_wave10.json"
_CORPUS = _HERE / "p2_corpus_wave10" / "manifest.json"
_STAGED = _HERE / "p2_staged_manifest_wave10.json"

_ALLOWED_GATE_TYPES = frozenset({"oracle", "libtest", "deferred"})


class P2ConformanceWave10GateTests(unittest.TestCase):
