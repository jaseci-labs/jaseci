"""P2 wave-11 c2jac corpus lift + Tier-B density ratchet."""
...
_BASELINE = _HERE / "p2_corpus_wave11" / "baseline" / "project.c2jac.report.json"
_LIFT = _HERE / "lift_p2_corpus_wave11.py"
...
class P2CorpusWave11GateTests(unittest.TestCase):
    @classmethod
