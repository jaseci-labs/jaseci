"""P2 wave-4 c2jac corpus lift + Tier-B density ratchet."""
...
_BASELINE = _HERE / "p2_corpus_wave4" / "baseline" / "project.c2jac.report.json"
_LIFT = _HERE / "lift_p2_corpus_wave4.py"
...
class P2CorpusWave4GateTests(unittest.TestCase):
    @classmethod
