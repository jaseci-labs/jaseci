...
- source: reference/cpython/Lib/test/test_int.py
- guest leg: 0/16 marks
- pins: **13 passed** / 16 run (+26 quarantined of 42 extracted)

| pin | result | got |
|---|---|---|
| IntTestCases.test_basic | GUEST-WRONG-OUTPUT | GOT<"ORACLE_EXC TypeError 'bad operand type for unary -'"> |
| IntTestCases.test_invalid_signs | PASS | |
| IntTestCases.test_unicode | PASS | |
| IntTestCases.test_underscores | GUEST-WRONG-OUTPUT | RUN<"ModuleNotFoundError: No module named 'test.support.numbers'"> |
...
| IntStrDigitLimitsTests.test_int_max_str_digits_is_per_interpreter | GUEST-WRONG-OUTPUT | GOT<"ORACLE_EXC AttributeError 'adjust_int_max_str_digits'"> |
| PyLongModuleTests.test_pylong_int_divmod | PASS | |
...
| IntTestCases.test_int_base_indexable | uses-self.value |
...
| IntStrDigitLimitsTests.test_max_str_digits_edge_cases | uses-self.int_class |
| IntStrDigitLimitsTests.test_max_str_digits | self.check |
...
| IntStrDigitLimitsTests.test_underscores_ignored | self.int_class |
| IntStrDigitLimitsTests.test_sign_not_counted | uses-self.int_class |
| IntStrDigitLimitsTests.test_int_from_other_bases | self._other_base_helper |
| PyLongModuleTests.test_pylong_int_to_decimal | self._test_pylong_int_to_decimal |
| PyLongModuleTests.test_pylong_roundtrip | self.assertNotStartsWith |
| PyLongModuleTests.test_pylong_str_to_int | host-raised:ValueError: Exceeds the limit (4300 digits) for integer string conversion; use sys.set_int_max_str_digits() to increase the limit |

## Expected vs got

### IntStrDigitLimitsTests.test_int_max_str_digits_is_per_interpreter (GUEST-WRONG-OUTPUT)

- expected: host oracle = `ok`
- got: GOT<"ORACLE_EXC AttributeError 'adjust_int_max_str_digits'">

### IntTestCases.test_basic (GUEST-WRONG-OUTPUT)
