...
- guest leg: 0/4 marks
- pins: **2 passed** / 4 run (+5 quarantined of 9 extracted)
...
| PickleBufferTest.test_raw | GUEST-WRONG-OUTPUT | GOT<"ORACLE_EXC TypeError 'memoryview.**enter**() takes no arguments (1 given)'"> |
...
### PickleBufferTest.test_raw (GUEST-WRONG-OUTPUT)
