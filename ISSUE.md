...
1. High: normal React and Preact JSX is still not fixed at the producer
...
1. High: the shared fragment implementation is not backend-neutral
...
1. High: the regex finalizer repeats established compiler functionality
...
1. Medium: the regression suite is oversized and locks in the workaround
